...
class Fdb {
     ...
     * (un array di array associativi, ognuno di questi rappresenta una riga del risultato della query)
     *
     * @return array
     */
     ...
     * (un array associativo che rappresenta la prima riga del risultato della query)
     * 
     * N.B. le evuntuali altre righe vengono scartate ($this->_result=false;)
     *
     * @return array
     */
...
//             $filtro .= ' `'.$parametri[$i][0].'` '.$parametri[$i][1].' \''.$parametri[$i][2].'\'';
            $filtro .= ' LOWER('.$parametri[$i][0].') '.$parametri[$i][1].' LOWER(\''.$parametri[$i][2].'\')';
