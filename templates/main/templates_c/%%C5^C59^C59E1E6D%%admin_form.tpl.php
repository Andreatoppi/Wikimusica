<?php /* Smarty version 2.6.26, created on 2016-10-27 00:06:21
         compiled from admin_form.tpl */ ?>
...
<a id="anchor-contact-1"></a>
        ...
        <div class="content-1col-nobox">
          &emsp;&emsp;&emsp;&emsp;<h1 class="contact"><b>Scheda in richesta di accettazione, prendi visione</b></h1>
...
" id="genere" class="field" tabindex="8"></p> 
              ...
              <fieldset>                   
                ...
                <p><input type="submit" name="submit" id="submit_1" class="button" value="Torna indietro" tabindex="10" /></p>
               </fieldset>
            </form>
          </div>
        </div>
